#include "src/solver/SolverMinPotentialNaiveTorch.hpp"
...
int main(int argc, char* argv[])
{
  ...
  /// seed
  torch::cuda::manual_seed(std::stoi(argv[2]));
  /// dump_base_path
  ...
  auto solver_min_potential = SolverMinPotentialNaiveTorch<double>(n, dump_base_path);
